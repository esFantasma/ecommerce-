...
LOAD THE DYNAMIC PRODUCT TABLE
=============================================*/
...
$(".fotoPortada").change(function(){
	...
	/*=============================================
  	...
  	WE VALIDATE THE FORMAT OF THE IMAGE SEA JPG OR PNG
  	=============================================*/
...
$(".guardarProducto").click(function(){
	...
	WE ASK IF THE COMPULSORY FIELDS ARE FULL
	=============================================*/
	...
	if($(".tituloProducto").val() != "" && 
	   ...
	   $(".pClavesProducto").val() != ""){
		...
		/*=============================================
	   	...
	   	WE ASK IF IMAGES COME FOR MULTIMEDIA OR YOUTUBE LINK
	   	=============================================*/
		...
		success: function(respuesta){
			...
			=============================================*/
				...
				if(respuesta[0]["multimedia"] != ""){
					...
					WHEN WE ELIMINATE AN IMAGE FROM THE LIST
					=============================================*/
			...
			$.ajax({
					...
					success: function(respuesta){
						...
						WE LOAD THE ID OF THE HEADBAND
						=============================================*/
			...
			WE CHARGE THE PRICE, WEIGHT AND DELIVERY DAYS
			=============================================*/
			...
			CREATE A NEW OFFER WHEN EDITING
			=============================================*/
