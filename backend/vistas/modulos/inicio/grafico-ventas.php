...
foreach ($ventas as $key => $value) {
	...
	/*=============================================
  	...
  	PERCENTAGES METHODS OF PAYPAL PAYMENT
  	=============================================*/
  	...
  	PERCENTAGES METHODS OF PAYMENT PAYU
  	=============================================*/
	...
	if($value["metodo"] != "gratis"){
		...
		#Capture only the year and the month
		$fecha = substr($value["fecha"],0,7);

		#Capturamos las fechas en un array
		#Capture the dates in an array
		array_push($arrayFechas, $fecha);

		#Capturamos las fechas y los pagos en un mismo array
		#Capture the dates and payments in the same array
		$arrayFechaPago = array($fecha => $value["pago"]);

		#Sumamos los pagos que ocurrieron el mismo mes
		#We add the payments that happened the same month
