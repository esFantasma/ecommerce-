...
VIEW THE BASKET OF THE SHOPPING CART
=============================================*/
...
VIEW THE PRODUCTS ON THE SHOPPING CART PAGE
		...
		function funcionForEach(item, index){
			...
			$.ajax({
				...
				success: function(respuesta){
					...
					AVOID MANIPULATING THE AMOUNT IN VIRTUAL PRODUCTS
					=============================================*/
...
$(".agregarCarrito").click(function(){
	...
	STORE IN THE LOCALSTARGE THE PRODUCTS ADDED TO THE CART
	=============================================*/
	...
	if(agregarAlCarrito){
		...
		SHOW ALERT THAT THE PRODUCT WAS ALREADY ADDED
		=============================================*/
...
$(document).on("click", ".quitarItemCarrito", function(){
	...
	IF THERE ARE STILL PRODUCTS RETURN TO ADD TO THE CART (LOCALSTORAGE)
	=============================================*/
	...
	if(idProducto.length != 0){
		...
		IF THERE ARE NO PRODUCTS, YOU HAVE TO REMOVE EVERYTHING
		=============================================*/	
...
GENERATE SUBTOTAL AFTER CHANGE AMOUNT
=============================================*/
$(document).on("change", ".cantidadItem", function(){
	...
	UPDATE THE AMOUNT IN THE LOCALSTORAGE
	=============================================*/
...
UPDATE BASKET BY CHANGING AMOUNT
=============================================*/
...
$("#btnCheckout").click(function(){
	...
	for(var i = 0; i < titulo.length; i++){
		...
		EVALUATE THE WEIGHT ACCORDING TO THE AMOUNT OF PRODUCTS
		=============================================*/
		...
		SELECT SHIPPING COUNTRY IF THERE ARE PHYSICAL PRODUCTS
		=============================================*/
	...
	if(tipoArray.find(checkTipo) == "fisico"){
		...
		EVALUATE SHIPPING FEES IF THE PRODUCT IS PHYSICAL
		=============================================*/
...
METHOD OF PAYMENT FOR CHANGE OF CURRENCY
=============================================*/
...
FUNCTION FOR THE CHANGE OF CURRENCY
=============================================*/
		...
		$.ajax({
	      ...
	      success:function(respuesta){
	          ...
	          if(modo == "sandbox"){
			   ...
			   $(".formPayu input[name='responseUrl']").attr("value", rutaOculta+"index.php?ruta=finalizar-compra&payu=true&idUsuario="+idUsuario+"&productos="+productos+"&cantidad="+cantidad+"&pago="+pago);
...
$(".agregarGratis").click(function(){
	...
	VERIFY THAT YOU DO NOT HAVE THE PRODUCT ACQUIRED
	=============================================*/
